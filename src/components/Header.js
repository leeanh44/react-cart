...
const MenuLink = ({title, to, exactLink}) => {
    return (
        <Route path={to} exact={exactLink} children={({macth}) => {
            var active = macth ? 'active' : '';
            return (
                <li className="breadcrumb-item">
                    <Link className={ active }  to={to}>{ title }</Link>
                </li>
            )
        }} />
    )
            ...
            <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                ...
                <div className="breadcrumb-dn mr-auto">
                    <ol className="breadcrumb header-breadcrumb">
                        {/* <MenuLink exactLink={true} to="/" title="Home"></MenuLink>
                        <MenuLink exactLink={false} to="/about" title="About"></MenuLink> */}
                        <MenuLink exactLink={false} to="/end-user" title="End user"></MenuLink>
                        <MenuLink exactLink={false} to="/system" title="System"></MenuLink>
                        <MenuLink exactLink={false} to="/end-user/shopping" title="Shopping"></MenuLink>
                        ...
                        <MenuLink exactLink={false} to="/end-user/login" title="Login"></MenuLink>
                        {/* <MenuLink exactLink={false} to="/product/create" title="Create product"></MenuLink> */}
                    </ol>
                </div>
